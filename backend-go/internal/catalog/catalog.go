...
var OreTypes = []BlockType{
	...
	{Type: "REDSTONE_ORE", Label: "红石矿石", BlockIDs: []string{"minecraft:redstone_ore", "minecraft:lit_redstone_ore"}},
	{Type: "DEEPSLATE_REDSTONE_ORE", Label: "深层红石矿石", BlockIDs: []string{"minecraft:deepslate_redstone_ore", "minecraft:lit_deepslate_redstone_ore"}},
	...
	{Type: "QUARTZ_ORE", Label: "下界石英矿石", BlockIDs: []string{"minecraft:quartz_ore", "minecraft:nether_quartz_ore"}},
...
var SaplingTypes = []BlockType{
	...
	{Type: "MANGROVE_PROPAGULE", Label: "红树胎生苗", BlockIDs: []string{"minecraft:mangrove_propagule"}},
